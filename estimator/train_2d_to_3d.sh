...
#python train_2d_to_3d.py --model mlp --output_path Pose2Mesh-60-1e-2-aaaaa --batch_size 8 --n_epochs 60 --max_lr 1e-2
#python train_2d_to_3d.py --model mlp --output_path Pose2Mesh-60-1e-3-aaaaa --batch_size 8 --n_epochs 60 --max_lr 1e-3
#python train_2d_to_3d.py --model mlp --output_path Pose2Mesh-60-1e-4-aaaaa --batch_size 8 --n_epochs 60 --max_lr 1e-4
#python train_2d_to_3d.py --model mlp --output_path Pose2Mesh-60-1e-3-aaaaa --batch_size 8 --n_epochs 60 --max_lr 1e-3
#python train_2d_to_3d.py --model sem_gcn --output_path try --batch_size 32 --n_epochs 2 --lr 1e-2
...
#python train_2d_to_3d.py --model sem_gcn --output_path SemGCN-20-1e-3 --batch_size 32 --n_epochs 20 --max_lr 1e-3
...
python train_2d_to_3d_temporal.py --model videopose3d --output_path try --batch_size 32 --n_epochs 2 --lr 1e-2