...
#python train_skeleton_classifier.py --model st_gcn --output_path ST-GCN-20-1e-4-nontemporal --batch_size 32 --n_epochs 20 --max_lr 1e-4
...
python train_skeleton_classifier.py --model mlp_trans_enc --output_path MLPTransformerModel-20-1e-3 --batch_size 32 --n_epochs 20 --max_lr 1e-3